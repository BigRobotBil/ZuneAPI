...
public class ChartController {
    ...
    @RequestMapping(value = "/*/*/music/chart/zune/albums/", method = RequestMethod.GET)
    public String getAlbumCharts(@PathVariable String id, @RequestParam Map<String, String> params) {
        return getAlbumCharts.handle(new HashMap<>());
    }

    @RequestMapping(value = "/*/*/music/chart/zune/playlists/", method = RequestMethod.GET)
    public String getPlaylistCharts(@PathVariable String id, @RequestParam Map<String, String> params) {
        return getPlaylistCharts.handle(new HashMap<>());
    }

    @RequestMapping(value = "/*/*/music/chart/zune/tracks/", method = RequestMethod.GET)
    public String getTrackCharts(@PathVariable String id, @RequestParam Map<String, String> params) {
